...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Thank you for joining <strong>${realmName}</strong>! To complete your registration and ensure the security of your account, please verify your email address by clicking the button below.</p>
